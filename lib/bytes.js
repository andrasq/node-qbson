...
// use our very own copies of these functions, do not let other users deoptimize them
delete require.cache[require.resolve('ieee-float')];
delete require.cache[require.resolve('./utf8-2')];
